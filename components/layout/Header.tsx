...
// Pages whose first section has a dark background (header uses white text when near top)
const DARK_TOP_PATHS = ["/", "/propiedades", "/contacto", "/nosotros", "/emprendimientos", "/alquiler-temporario"];
...
export default function Header() {
  ...
  // Use white text when near the top of a page that has a dark first section
  const isDark =
    !scrolled &&
  ...
  return (
    <>
      <div className="fixed top-4 left-0 right-0 z-50 px-4 sm:px-6 lg:px-8">
        <header
          className={cn(
            "max-w-7xl mx-auto flex items-center justify-between px-5 py-3 rounded-2xl transition-all duration-300 border shadow-[0_8px_32px_rgba(0,0,0,0.12)]",
            isDark
              ? "bg-white/10 backdrop-blur-2xl border-white/20"
              : "bg-white/80 backdrop-blur-2xl border-gray-200/50 shadow-[0_4px_24px_rgba(0,0,0,0.08)]"
          )}
        >
          {/* Logo */}
          ...
          <div className="flex items-center gap-5">
            ...
            <a
              ...
              className={cn(
                ...
                isDark
                  ? "text-white/90 hover:text-[#25D366]"
                  : "text-[#1a1a2e]/70 hover:text-[#25D366]"
              )}
            >
            ...
            <a
              ...
              className={cn(
                "transition-colors drop-shadow-sm",
                isDark
                  ? "text-white/90 hover:text-[#E1306C]"
                  : "text-[#1a1a2e]/70 hover:text-[#E1306C]"
              )}
            >
            ...
            <button
              ...
              className={cn(
                "md:hidden p-1 transition-colors drop-shadow-sm",
