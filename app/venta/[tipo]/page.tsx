...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: `Encontrá ${propType.name.toLowerCase()}s en venta en Villa Devoto. Amplio catálogo con todos los detalles y fotos.`,
  };
}
      ...
      <div className="bg-[#0c1b2e] pt-28 pb-10 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <nav className="text-sm text-white/50 mb-3">
            ...
            <a href="/propiedades?operacion=venta" className="hover:text-white/80">Venta</a>
            <span className="mx-2">›</span>
